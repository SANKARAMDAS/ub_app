...
data class CardScannerOptions(
  ...
  constructor(parcel: Parcel) : this(
          ...
          cardHolderNameBlackListedWords = parcel.createStringArrayList()?.toList()?: listOf<String>(),
          ...
          possibleCardHolderNamePositions = parcel.createStringArrayList()?.toList()?: listOf<String>()
  )
